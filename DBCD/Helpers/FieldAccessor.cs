    ...
    internal class FieldAccessor
    {
        ...
        public FieldAccessor(Type type, string[] fields)
        {
            ...
            foreach (var field in fields)
            {
                ...
                var conversionMethod = typeof(FieldAccessor)
                    .GetMethod(nameof(ConvertValue), System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static)
                    .MakeGenericMethod(fieldExpression.Type);
                var convertedValueExpression = Expression.Call(conversionMethod, valueParameter);
                var assignExpression = Expression.Assign(fieldExpression, convertedValueExpression);
